---
name: deno-frontend
description: Use when building web UIs with Fresh framework, using Preact components, or adding Tailwind CSS styling in Deno. Covers island architecture, routing, and component patterns.
license: MIT
metadata:
  author: denoland
  version: "1.0"
